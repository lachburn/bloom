      ...
      <div>
        ...
        <div className="flex gap-3">
          <button
            ...
            className="w-12 h-12 rounded-2xl bg-bloom-50 flex items-center justify-center text-2xl flex-shrink-0"
          >
            {emoji}
          </button>
          <input
      ...
      <AnimatePresence mode="wait">
        {type === 'timed' && (
          ...
          >
            ...
            />
            {errors.duration && <p className="text-rose-300 text-xs mt-1">{errors.duration}</p>}
          </motion.div>
        )}
        ...
        {type === 'quantity' && (
          ...
          >
            ...
            <div>
              <label className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1.5 block">Increment</label>
            ...
            {errors.goal && <p className="text-rose-300 text-xs mt-1">{errors.goal}</p>}
          </motion.div>
        )}
